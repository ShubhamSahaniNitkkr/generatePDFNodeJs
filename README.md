...
```bash
npm install && npm run uiinstall && npm run demo
```

## Live Demo

[https://shubhamsahaniNitkkr.github.io/generatePDFNodeJs/](https://shubhamsahaniNitkkr.github.io/generatePDFNodeJs/)
